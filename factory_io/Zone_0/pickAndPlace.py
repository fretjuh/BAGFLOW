...
#             "status_bagage_id": 1,
#             "inlevertijd": time.strftime("%Y-%m-%d %H:%M:%S")
#         },
#             timeout=5
#         )

#         log(
#             f"Created baggage RFID {rfid}"
#         )

#         if response.status_code not in [200, 201]:

#             log(
#                 f"Create baggage failed: {response.status_code}"
#             )
